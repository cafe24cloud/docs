...
보안 서비스 > 인증서 관리에서 등록한 인증서에 대한 다음과 같은 정보를 확인할 수 있습니다.
...
인증서에 대한 알람을 받는 방법은 다음과 같습니다.

콘솔 오른쪽 상단의 계정명 > 알람관리 > \[관리자 추가] 버튼을 클릭한 후, 아래의 내용을 입력합니다.

* 대상 : 계정 가입자 및 서비스 관련 알람 수신을 허용한 관리자
* 수단 : SMS, E-mail
* 발송 항목&#x20;
...
보안 서비스 > 인증서 관리 > 삭제할 인증서의 상세정보 탭에서 \[삭제] 버튼을 클릭합니다.
